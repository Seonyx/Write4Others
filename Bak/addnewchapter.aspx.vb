...
Public Class addnewchapter
    ...
    Protected Sub bind_existingchapterdropdown()
        msg_existingchapterdropdown.Text = ""
        ...
        Try
            ...
            If myreader.HasRows Then
                existingchapterdropdown.DataSource = myreader
                existingchapterdropdown.DataValueField = "chaptername"
                existingchapterdropdown.DataTextField = "chaptername"
                existingchapterdropdown.DataBind()
            Else
                msg_existingchapterdropdown.Text = msg_existingchapterdropdown.Text & " Error getting chapter list"
            End If
            myreader.Close()
            cn.Close()
        Catch ex As Exception
            ...
            existingchapterdropdown.Visible = False
            msg_existingchapterdropdown.Text = "No chapter Found"
        End Try
    End Sub

    Protected Sub submitnewnchaptername_click(sender As Object, e As EventArgs) Handles submitnewnchaptername.Click
        ...
        If checknewchaptername(newchapternametext) = False Then
            ...
            Try
                ...
                st1 = "insert into chapter(chaptername,DatechapterCreated,chapterispublished,chapterGuid)"
                st2 = " values(@chaptername, SYSUTCDATETIME(), 0,NewID())"
        ...
        If submitchapterflag = True Then
            ...
            Response.Redirect(addnewchaptereditor & "&sn=" & getchapterIDnumber(newchapternametext))
        Else
            Response.Redirect(addnewchaptererror & "&err=unknown")
        End If
    End Sub
    ...
    Function getchapterIDnumber(newchaptername) As Integer
        ...
        Try
            ...
            Dim strsql As String = ""
            cmd.Parameters.Add("@chaptername", SqlDbType.VarChar, 255).Value = newchaptername
            strsql = "SELECT chapter.chapterID  FROM chapter where chapter.chaptername = @chaptername"
            cn.ConnectionString = ConfigurationManager.AppSettings("MSSQLConnectionString")
            cn.Open()
            cmd.Connection = cn
            cmd.CommandText = strsql
    ...
    Function gopopulateform(seriesnumber)
